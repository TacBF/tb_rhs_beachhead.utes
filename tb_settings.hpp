  ...
  class mission
  {
    ...
    class scoring
    {
      class tickets
      {
        ...
        bluFor = 80; // "_rate" is dependent on the "missionScale".
        opFor = 10;
      };
    };
  };
    ...
    class roles
    {
      ...
      kits[] =
      {
        // BLUFOR or ALL factions
        {
          ...
          {__ICE_gear_LightAT, "Light AT", 6, 0, 0, 2, 3},
          ...
          {__ICE_gear_Diver, "Diver", __unlimited, 0, 0, 0, 0}
                },
